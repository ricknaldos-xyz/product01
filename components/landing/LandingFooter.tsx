      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="border-t border-border mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <a
              href="https://instagram.com/sporttek"
              target="_blank"
            ...
            <a
              href="https://twitter.com/sporttek"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center hover:bg-foreground hover:text-background transition-colors"
            ...
            <a
              href="https://youtube.com/@sporttek"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center hover:bg-foreground hover:text-background transition-colors"
              aria-label="YouTube"
            ...
            <a
              href="https://tiktok.com/@sporttek"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center hover:bg-foreground hover:text-background transition-colors"
              aria-label="TikTok"
          ...
          <p className="text-sm text-muted-foreground">
            &copy; 2026 SportTek. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>

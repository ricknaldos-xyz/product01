...
export const socialWriteLimiter = rateLimit({ key: 'social-write', limit: 10, window: 60 }) // 10 per minute
export const goalLimiter = rateLimit({ key: 'goal', limit: 5, window: 60 })              // 5 per minute
